...
\begin{enumerate}
    \item GitHub - narzędzie do storzenia repozytorium
    ...
    \item R - biblioteki {RMariaDB, kableExtra, dplvr, ggplot2, scales}
...
\begin{enumerate}
    \item Analiza w formacie .ipynb
    \item Analiza w formacie .py
    \item Analiza w formacie .R
...
\begin{enumerate}
    ...
    \item Uruchomić w VS po kolei create.py -> schemat.sql -> generate.py
