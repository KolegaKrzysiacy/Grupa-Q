...
PRODUCENCI = ["Speedy Wheels", "TurboTech", "Nitro Labs", "Quantum Motors", "HyperDrive", "SuperSpeed"]
MODELE = ["Swift X1", "Swift Pro", "RoadFlash", "Speedster", "Turbo ZR", "Turbo ZR Pro", "Boost GT", "Overdrive", "Nitro GT", "Nitro Sprint", "Nitro X", "Nitro Evo", "Quantum S", "Quantum One", "Quantum Prime", "Quantum RS", "Hyper V", "Hyper Max", "Hyper Pulse", "Hyper Core"] #Każde 5 kolejnych odpowiada jednemu z producentów
...
SUBSTANCJE = ["mikstura siły", "mikstura szybkości", "mikstura wysokiego skoku", "mikstura niewidzialności", "mikstura widzenia w ciemności"]
TYPY_ZRODEL_FINANSOWANIA = ["reklamy w przerwach", "lokowanie produktu", "reklamy na bandach", "reklamy na stronie wydarzenia", "reklamy na biletach", "reklamy na pojazdach", "dotacja"]
RODZAJE_KOSZTOW = ["wynajem obiektu", "nagrody dla zawodników", "obsługa techniczna", "opieka weterynaryjna", "podłoża", "sprzęt", "inne"]
NAZWY_FIRM = ["SpeedRun Media", "TurboAds", "NeonVision", "PowerPlay Group", "AdStorm", "PixelWave", "HyperPromo", "BrightLine", "MediaForge", "ClickZone", "EventSpark", "BrandShift", "FastTrack Ads", "PromoSphere", "VisionBoost", "AdPulse", "SpotLight Media", "MegaReach", "FocusPoint", "PrimeExposure"]
ZODIAKI = ["Baran", "Byk", "Bliźnięta", "Rak", "Lew", "Panna", "Waga", "Skorpion", "Strzelec", "Koziorożec", "Wodnik", "Ryby"]
CHCEMY_PRACOWNIKOW = [1]*15 + [2]*24 + [3]*16 #id stanowisk

MALE = ["Ada", "Alga", "Arka", "Amfa", "Arwena", "Aida", "Agrafka", "Ayla", "Ami", "Andromeda", "Alma", "Alka", "Ana", "Ayah", "Anga", "Alimka", "Anja", "Ashlee", "Aniela", "Adelajda", "Ali", "Baryłka", "Bunia", "Bella", "Baja", "Bambi", "Berta", "Bianka", "Borówka", "Buba", "Buśka", "Buffy", "Blanka", "Bombelka", "Betty", "Boba", "Bela", "Baśka", "Bomba", "Brenia", "Biedronka", "Bunny", "Bajka", "Bloom", "Bubi", "Bibi", "Bijou", "Czarna", "Czaja", "Czarusia", "Cytrynka", "Chrumcia", "Chwila", "Cola", "Cynia", "Corni", "Cukierek", "Chmurka", "Ciapcia", "Czakra", "Cyrkonia", "Chrupcia", "Chomka", "Chomusia", "Czika", "Doris", "Dudusia", "Dragona", "Dixi", "Didi", "Delirka", "Dziuba", "Daisy", "Doty", "Doda", "Dolly", "Dynia", "Dafne", "Dania", "Dercia", "Duśka", "Dosia", "Diana", "Dżina", "Dresiara", "Elza", "Elma", "Enya", "Emma", "Estera", "Ebola", "Emka", "Efka", "Emi", "Echinacea", "Erka", "Emilia", "Eli", "Fufcia", "Fryga", "Fredzia", "Frytka", "Fifka", "Fiona", "Frania", "Felka", "Frela", "Fantazja", "Fenia", "Funia", "Fusia", "Franczi", "Fikuś", "Flora", "Fauna", "Fanta", "Gala", "Ganja", "Gryzia", "Glusia", "Grypa", "Gapa", "Grucha", "Gucia", "Gryzetka", "Gaja", "Gruba", "Gangsterka", "Halka", "Heidi", "Hafka", "Holka", "Hapka", "Hipka", "Igiełka", "Inia", "Inka", "Issa", "Irma", "Ixi", "Iluzja", "Iga", "Ina", "Itka", "Iwa", "Iskierka", "Isis", "Jaśmina", "Jędza", "Jadźka", "Japka", "Julka", "Jani", "Jerka", "Jagoda", "Julia", "Kokardka", "Kinia", "Kunia", "Kicia", "Kusia", "Kiki", "Kaja", "Kitty", "Klamka", "Kama", "Kiara", "Kira", "Kora", "Kredka", "Koka", "Kropka", "Kuczi", "Klucha", "Kluska", "Kruszynka", "Kudła", "Kika", "Kaśka", "Kinga", "Kate", "Klara", "Księżniczka", "Kundzia", "Kornelia", "Kordelia", "Lisa", "Lora", "Lizze", "Lalusia", "Lola", "Lizi", "Lusia", "Lili", "Lucky", "Luelle", "Lana", "Lula", "Lara", "Loona", "Lala", "Luna", "Luśka", "Laura", "Lubelka", "Lisee", "Łezka", "Łatka", "Łajka", "Łuna", "Łanka", "Łupinka", "Mysia", "Myszka", "Milunia", "Mini", "Misia", "Milusia", "Minia", "Mika", "Miłka", "Mizia", "Mona", "Mila", "Minako", "Micia", "Milka", "Musia", "Maja", "Maga", "Mysza", "Mycha", "Madi", "Mimi", "Mirabella", "Meg", "Mela", "Miga", "Mafia", "Malina", "Mitia", "Miśka", "Miziołka", "Misiunia", "Mara", "Mimbla", "Mozarella", "Miżu", "Mała", "Migotka", "Monia", "Nitka", "Niunia", "Niki", "Nel", "Niosia", "Ninuś", "Nancy", "Nonka", "Nastka", "Nerka", "Norka", "Nikita", "Nicola", "Olivka", "Orka", "Oda", "Ola", "Omka", "Omega", "Ostanka", "Opka", "Okarka", "Oska", "Oponka", "Prima", "Pusia", "Pentelka", "Pami", "Pati", "Perelka", "Pixi", "Poli", "Plumcia", "Pimpka", "Paja", "Puchata", "Psotka", "Pestka", "Ptysia", "Pucia", "Punia", "Pandzia", "Pulpa", "Paris", "Pinia", "Pysia", "Pepsi", "Perełka", "Rozetka", "Roksa", "Roborka", "Rosa", "Renia", "Ritka", "Rudzia", "Ruda", "Rutka", "Róża", "Rodzynka", "Roksana", "Rozalia", "Sasetka", "Sonia", "Sawka", "Saba", "Sabi", "Sissi", "Sali", "Sara", "Szpulka", "Stella", "Śnieżynka", "Śnieżka", "Teri", "Tusia", "Texa", "Taja", "Tupcia", "Topcia", "Tola", "Tequilla", "Tina", "Tinka", "Titinka", "Tarka", "Tosia", "Wróżka", "Walentynka", "Walcia", "Wania", "Wólka", "Wojka", "Właźka", "Wenka", "Wanilia", "Wiki", "Vena", "Vega", "Zuzia", "Zuza", "Zosia", "Zelda"]
FEMALE = ["Anatol", "Arsen", "Ananas", "Albi", "Artis", "Aksel", "Aplauz", "Aster", "Afro", "Agrest", "Ares", "Amon", "Aresik", "Atłas", "Andy", "Arti", "Ali", "Alfred", "Alan", "Arnold", "Bary", "Bambo", "Bolek", "Baksik", "Bakuś", "Bubuś", "Buu", "Bobek", "Badi", "Beni", "Benio", "Bos", "Bubel", "Burczek", "Bunny", "Bingo", "Black", "Blue", "Brown", "Burczuś", "Boo", "Bob", "Boberek", "Bodzio", "Borys", "Czarny", "Czarlie", "Cymbał", "Cear", "Cynamon", "Czubek", "Cekin", "Chinsi", "Czaruś", "Ciapek", "Czupurek", "Cokół", "Cętek", "Ciapcio", "Cheops", "Chmurek", "Cheddar", "Czester", "Cheese", "Cytrus", "Chrumcio", "Cuduś", "Czapek", "Chrupek", "Cheep", "Chomek", "Cyryl", "Chum-Chum", "Chomiszczurek", "Dyzio", "Dozer", "Dudi", "Dymitr", "Dex", "Duduś", "Dziubek", "Domino", "Dexter", "Dabuś", "Dulek", "Donald", "Dewon", "Dołker", "Dred", "Dudek", "Dolar", "Dile", "Deil", "Dropek", "Drops", "Dżampi", "Dżet", "Dingo", "Dreptak", "Drapek", "Dodo", "Dziobak", "Eklerek", "Emuś", "Elfik", "Eukaliptus", "Edzio", "Emax", "Eni", "Eddie", "Forest", "Florek", "Frodo", "Filek", "Felix", "Farod", "Fiodor", "Fazzy", "Fluś", "Fafik", "Fafi", "Frosio", "Ferdek", "Fufel", "Fiki", "Fax", "Felek", "Fiszer", "Filutek", "Faraon", "Franek", "Gutek", "Guzik", "Groszek", "Gluś", "Gamoń", "Gumiś", "Grubas", "Gryzek", "Generał", "Gustlik", "Gambon", "Grizzli", "Gangster", "Gargamel", "Gucio", "Gumie", "Gapcio", "Głuptas", "Golfy", "Goguś", "Hamtaro", "Hopek", "Hantaro", "Homek", "Hamkuś", "Hipcio", "Idi", "Iki", "Irokez", "Irys", "Igloo", "Iksel", "Imbir", "Izet", "Izzy", "Imer", "Ix", "Ingo", "Jet", "Joe", "Junior", "Jazi", "Józek", "Jack", "Jakub", "Kubuś", "Karol", "Kajtuś", "Kacper", "Korek", "Kori", "Kuki", "Kropek", "Koki", "Kłapouszek", "Kieł", "Kokos", "Kaktus", "Kajzer", "Kajek", "Kopytko", "Kumpel", "Klops", "Keks", "Kovu", "Kulek", "Krecik", "Koksik", "Kajtek", "Lorek", "Lotek", "Lucky", "Lemming", "Leo", "Lolek", "Laser", "Lejek", "Lux", "Lasso", "Latex", "Lordi", "Lucek", "Luzak", "Łili", "Łoli", "Łatek", "Łaciak", "Łak", "Łubinek", "Łupuś", "Łosiek", "Miki", "Myszor", "Master", "Misio", "Myszorek", "Mars", "Mailo", "Mentos", "Miluś", "Moni", "Mikuś", "Mufcio", "Miś", "Milunio", "Miodzik", "Majonez", "Moryc", "Matrix", "Mordek", "Monty", "Merlin", "Milton", "Modi", "Madagaskar", "Miłek", "Magik", "Mokry", "Morte", "Mały", "Morda", "Mikołaj", "Morsik", "Michael", "Max", "Maurycy", "Norek", "Neli", "Nero", "Net", "Nosek", "Nemo", "Neo", "Neon", "Nutek", "Nerw", "Nicolas", "Orbit", "Ogryzek", "Opis", "Otto", "Ozzy", "Omar", "Opos", "Oset", "Pank", "Pimpuś", "Parszywek", "Pupil", "Piescioch", "Puszek", "Pixel", "Pikuś", "Pinki", "Papilot", "Puchatek", "Pionek", "Piknik", "Pyszczek", "Pysio", "Pinip", "Pucuś", "Pepsi", "Persil", "Rudi", "Redi", "Roi", "Roki", "Ron", "Rubiś", "Red", "Rafcio", "Rafio", "Rafiki", "Ramzes", "Romeo", "Stinki", "Sniki", "Szczurek", "Skin", "Skipi", "Skiper", "Spioszek", "Spagetti", "Skalar", "Smok", "Śliniak", "Smarkuś", "Supeł", "Shrek", "Śliwka", "Stefcio", "Szprot", "Śmierdziuszek", "Snoopy", "Stiuart", "Smerf", "Spider", "Sprite", "Stan", "Śpioch", "Tuptuś", "Tupcio", "Timor", "Tuptus", "Tobi", "Trix", "Totek", "Taiki", "Tonio", "Torek", "Traf", "Tiburek", "Tutuś", "Topik", "Tofik", "Thierry", "Tadek", "Węzeł", "Wani", "Wanil", "Wipi", "Wafel", "Worek", "Wolwo", "Wacuś", "Velvet", "Voy", "Znajduś", "Zygo", "Ziutek", "Zyzio", "Ząbek", "Żwirek", "Żelek"]
...
for i in range(ILE_ZAWODOW):
    ...
    wszystkie = random.sample(range(1, ILE_KONKURENCJI + 1), CZAS_TRWANIA_ZAWODOW[i] * ile_na_dzien)
    temp2 = []
...
NUMERY = random.sample(range(100000000, 999999999), ILE_NUMEROW) #żeby numery nie mogły się powtórzyć

#funkcje pomocnicze do generacji table
def to_tuples(lst): #przemienia [x, y, z] na [(x,), (y,), (z,)], żeby sql nie brał x, y i z za str, tylko tuple
...
def znajdz_koordynatorow(start, end, jobs):
    ...
    for _, (id_stanowiska, id_pracownika, zatrudnienie, zwolnienie) in enumerate(jobs):
        if id_stanowiska == 1 and zatrudnienie < start and (zwolnienie == None or zwolnienie > end):
...
def znajdz_sedziow(start, end, jobs):
    sedziowe = []
    for _, (id_stanowiska, id_pracownika, zatrudnienie, zwolnienie) in enumerate(jobs):
        if id_stanowiska == 2 and zatrudnienie < start and (zwolnienie == None or zwolnienie > end):
...
for i in range(ILE_FIRM):
    ...
    if random.random() < 0.1: #10% szans że już nie ma
        zakonczenie_wspolpracy = random.randrange(rozpoczecie_wspolpracy, KONIEC_DZIALANOSCI)
    else:
        zakonczenie_wspolpracy = None
    sponsorzy.append((nazwa_firmy, dane_kontaktowe, to_date(rozpoczecie_wspolpracy), to_date(zakonczenie_wspolpracy)))
...
for i, j in enumerate(CHCEMY_PRACOWNIKOW):
    ...
    zatrudnienie.append((id_stanowiska, id_pracownika, to_date(data_zatrudnienia), to_date(data_zwolnienia)))
...
for i in range(ILE_KONKURENCJI):
    if konkurencje[i][0] == 1: #kategoria naturalna, żeby nie dawało przeskód dla pojazdów
...
zawody = []
for i in range(ILE_ZAWODOW):
    data_rozpoczecia = random.randrange(int(POCZATEK_DZIALANOSCI + 0.5 * SEKUNDY_W_ROKU), KONIEC_DZIALANOSCI - 4 * SEKUNDY_W_DNIU)
    czas_trwania = CZAS_TRWANIA_ZAWODOW[i]
    data_zakonczenia = int(data_rozpoczecia + czas_trwania * SEKUNDY_W_DNIU)
    liczba_widzow = int(random.randint(300, 500) * ((data_rozpoczecia - POCZATEK_DZIALANOSCI) / SEKUNDY_W_ROKU))
    id_koordynatora = random.choice(znajdz_koordynatorow(to_date(data_rozpoczecia), to_date(data_zakonczenia), zatrudnienie))
    zawody.append((to_date(data_rozpoczecia), to_date(data_zakonczenia), liczba_widzow, id_koordynatora))
...
for id_zawodow, (data_rozpoczecia, data_zakonczenia, _, _) in enumerate(zawody):
    for dzien in range(CZAS_TRWANIA_ZAWODOW[id_zawodow]):
        ...
        for i in range(liczba_rozgrywek):
            ...
            id_sedzi = random.choice(znajdz_sedziow(data_rozpoczecia, data_zakonczenia, zatrudnienie))
            rozgrywki.append((id_zawodow + 1, JAKIE_KONKURENCJE[id_zawodow][dzien][i], data_rozgrywki, id_sedzi)) 
            m += 30
            if m == 60:
                m = 0
                h += 1
...
for i in range(ILE_CHOMIKOW):
    ...
    data_urodzenia = random.randrange(int(POCZATEK_DZIALANOSCI - 0.5 * SEKUNDY_W_ROKU), int(KONIEC_DZIALANOSCI - 0.5 * SEKUNDY_W_ROKU))
    dlugosc_zycia = bida_rozklad_normalny(1.5, 3)
    data_dolaczenia = random.randrange(max(POCZATEK_DZIALANOSCI, int(data_urodzenia + 0.5 * SEKUNDY_W_ROKU)), min(int(data_urodzenia + dlugosc_zycia * SEKUNDY_W_ROKU), KONIEC_DZIALANOSCI))
    ...
    chomiki.append((imie, id_wlasciciela, id_rasy, to_date(data_urodzenia), to_date(data_dolaczenia), to_date(data_odejscia)))
...
for _ in range(ILE_KONTROL):
    ...
    data_kontroli = random.randrange(int(datetime.combine(chomiki[id_chomika - 1][4], time.min).timestamp()), end)
...
for id_kontroli in range(ILE_KONTROL):
    for id_substancji in range(len(SUBSTANCJE)):
        kontrola_substancji.append((id_kontroli + 1, id_substancji + 1, 0)) #przez ilość kontroli boją się brać doping :)
...
for id_zawodow, (data_rozpoczecia, data_zakonczenia, liczba_widzow, koordynator) in enumerate(zawody):
    ...
    jakie_firmy = random.sample(list(range(1, len(sponsorzy)+1)) + [None], liczba_finansowan)
    for id_firmy in jakie_firmy:
        ...
        data_wplaty = random.randrange(int(datetime.combine(data_rozpoczecia, time.min).timestamp() - random.randrange(30, 60) * SEKUNDY_W_DNIU), int(datetime.combine(data_rozpoczecia, time.min).timestamp()))
        kwota = random.randint(10000, 100000)
        finansowanie.append((id_zawodow + 1, id_typu_finansowania, id_firmy, to_date(data_wplaty), kwota))
